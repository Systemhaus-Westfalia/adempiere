 ...
 */
public abstract class EI_CreateInvoice_NotaCredito_SVAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SHW_Create_ElectronicInvoice";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "SHW_Create_ElectronicInvoice";
	/** Process Id 	*/
