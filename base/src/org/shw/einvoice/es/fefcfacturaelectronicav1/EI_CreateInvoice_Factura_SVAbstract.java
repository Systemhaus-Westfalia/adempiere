...
/** Generated Process for (EI_CreateInvoice_Factura_SV.java)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.4
 */
public abstract class EI_CreateInvoice_Factura_SVAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "EI_CreateInvoice_Factura_SV.java";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "EI_CreateInvoice_Factura_SV.java";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 3000419;
