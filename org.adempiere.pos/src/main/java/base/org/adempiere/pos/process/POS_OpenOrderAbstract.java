 ...
 */
public abstract class POS_OpenOrderAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "POS_OpenOrder";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "POS_OpenOrder";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 1000071;
