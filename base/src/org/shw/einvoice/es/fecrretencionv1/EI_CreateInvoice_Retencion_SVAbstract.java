 ...
 */
public abstract class EI_CreateInvoice_Retencion_SVAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "EI_CreateInvoice_Retencion_SV";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "EI_CreateInvoice_Retencion_SV";
	/** Process Id 	*/
