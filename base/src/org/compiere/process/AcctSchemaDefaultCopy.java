	...
	protected String doIt () throws Exception
	{
		...
		if (p_CopyOverwriteAcct)
		{
			sql = "UPDATE M_Product_Category_Acct pa "
				...
				+ ", P_LandedCostClearing_Acct=" + acct.get_ValueAsInt("P_LandedCostClearing_Acct")
		...
		sql = "INSERT INTO M_Product_Category_Acct "
			...
			+ " P_MixVariance_Acct,P_Labor_Acct,P_Burden_Acct,P_CostOfProduction_Acct,P_OutsideProcessing_Acct,P_Overhead_Acct,P_Scrap_Acct, P_LandedCostClearing_Acct) "
			...
			+ " acct.P_MixVariance_Acct,acct.P_Labor_Acct,acct.P_Burden_Acct,acct.P_CostOfProduction_Acct,acct.P_OutsideProcessing_Acct,P_Overhead_Acct,P_Scrap_Acct, acct.P_LandedCostClearing_Acct "
		...
		if (!p_CopyOverwriteAcct)	//	Insert new Products
		{
			sql = "INSERT INTO M_Product_Acct "
				...
				+ " acct.P_TradeDiscountRec_Acct, acct.P_TradeDiscountGrant_Acct,"
				+ " acct.P_WIP_Acct,acct.P_FloorStock_Acct,acct.P_MethodChangeVariance_Acct,acct.P_UsageVariance_Acct,acct.P_RateVariance_Acct," 
				+ " acct.P_MixVariance_Acct,acct.P_Labor_Acct,acct.P_Burden_Acct,acct.P_CostOfProduction_Acct,acct.P_OutsideProcessing_Acct,acct.P_Overhead_Acct,acct.P_Scrap_Acct,acct.P_LandedCostClearing_Acct "
				+ "FROM M_Product p"
