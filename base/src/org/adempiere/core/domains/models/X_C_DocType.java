...
// N
	...
	/** Set Document Base Type.
		@param C_DocBaseType_ID Document Base Type	  */
	public void setC_DocBaseType_ID (int C_DocBaseType_ID)
	{
		if (C_DocBaseType_ID < 1) 
			set_Value (COLUMNNAME_C_DocBaseType_ID, null);
		else 
			set_Value (COLUMNNAME_C_DocBaseType_ID, Integer.valueOf(C_DocBaseType_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_DocBaseType_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
