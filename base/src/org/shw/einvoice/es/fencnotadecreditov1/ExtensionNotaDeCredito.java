 ...
 * 
 */
public class ExtensionNotaDeCredito implements Extension {
	...
	public String getPlacaVehiculo() {
		throw new UnsupportedOperationException("In Document Nota de Credito calling the method Extension.getPlacaVehiculo() is not allowed");
	}
	...
	public void setPlacaVehiculo(String placaVehiculo) {
		throw new UnsupportedOperationException("In Document Nota de Credito calling the method Extension.setPlacaVehiculo() is not allowed");
	}
