 ...
 */
public abstract class EI_ReadJsonResponseAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "EI_ReadJsonResponse";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "EI_ReadJsonResponse";
	/** Process Id 	*/
