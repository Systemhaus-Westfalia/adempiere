...
/** Generated Process for (PP_Product_BOM CopyFrom)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.0
 */
public abstract class CopyFromBOMAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "PP_Product_BOM CopyFrom";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "PP_Product_BOM CopyFrom";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 53004;
