...
// N
    ...
    {
		return (org.adempiere.core.domains.models.I_C_DocType)MTable.get(getCtx(), org.adempiere.core.domains.models.I_C_DocType.Table_Name)
			.getPO(getC_DoctypePO_ID(), get_TrxName());	}

	/** Set C_DoctypePO_ID.
		@param C_DoctypePO_ID C_DoctypePO_ID	  */
	public void setC_DoctypePO_ID (int C_DoctypePO_ID)
	{
		if (C_DoctypePO_ID < 1) 
			set_Value (COLUMNNAME_C_DoctypePO_ID, null);
		else 
			set_Value (COLUMNNAME_C_DoctypePO_ID, Integer.valueOf(C_DoctypePO_ID));
	}

	/** Get C_DoctypePO_ID.
		@return C_DoctypePO_ID	  */
	public int getC_DoctypePO_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_DoctypePO_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (org.adempiere.core.domains.models.I_E_Recipient_Identification)MTable.get(getCtx(), 
				org.adempiere.core.domains.models.I_E_Recipient_Identification.Table_Name)
			.getPO(getE_Recipient_Identification_ID(), get_TrxName());	}

	public void setE_Recipient_Identification_ID (int E_Recipient_Identification_ID)
	{
		if (E_Recipient_Identification_ID < 1) 
			set_Value (COLUMNNAME_E_Recipient_Identification_ID, null);
		else 
			set_Value (COLUMNNAME_E_Recipient_Identification_ID, Integer.valueOf(E_Recipient_Identification_ID));
	}
	...
	{
		return (String)get_Value(COLUMNNAME_EMail3);
	}
	...
	{
		set_Value (COLUMNNAME_isCA, Boolean.valueOf(isCA));
	}
	...
	public boolean isCA () 
	{
		Object oo = get_Value(COLUMNNAME_isCA);
		if (oo != null) 
		{
	...
	{
		set_Value (COLUMNNAME_isEXT, Boolean.valueOf(isEXT));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_isEXT);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set isGranContribuyente.
		@param isGranContribuyente isGranContribuyente	  */
	public void setisGranContribuyente (boolean isGranContribuyente)
	{
		set_Value (COLUMNNAME_isGranContribuyente, Boolean.valueOf(isGranContribuyente));
	}

	/** Get isGranContribuyente.
		@return isGranContribuyente	  */
	public boolean isGranContribuyente () 
	{
		Object oo = get_Value(COLUMNNAME_isGranContribuyente);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set IsInvoicedProForma.
		@param IsInvoicedProForma IsInvoicedProForma	  */
	public void setIsInvoicedProForma (boolean IsInvoicedProForma)
	{
		set_Value (COLUMNNAME_IsInvoicedProForma, Boolean.valueOf(IsInvoicedProForma));
	}

	/** Get IsInvoicedProForma.
		@return IsInvoicedProForma	  */
	public boolean isInvoicedProForma () 
	{
		Object oo = get_Value(COLUMNNAME_IsInvoicedProForma);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set isLGAgent.
		@param isLGAgent isLGAgent	  */
	public void setisLGAgent (boolean isLGAgent)
	{
		set_Value (COLUMNNAME_isLGAgent, Boolean.valueOf(isLGAgent));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_isLGAgent);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set IsNaturalPerson.
		@param IsNaturalPerson IsNaturalPerson	  */
	...
	/** Set isNotaDebito.
		@param isNotaDebito isNotaDebito	  */
	public void setisNotaDebito (boolean isNotaDebito)
	{
		set_Value (COLUMNNAME_isNotaDebito, Boolean.valueOf(isNotaDebito));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_isNotaDebito);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	{
		set_Value (COLUMNNAME_PersonalID, PersonalID);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_PersonalID);
	}
	...
	public org.adempiere.core.domains.models.I_C_Location getPlaceOfBirth() throws RuntimeException
    {
    ...
    {
		return (org.adempiere.core.domains.models.I_AD_User)MTable.get(getCtx(), org.adempiere.core.domains.models.I_AD_User.Table_Name)
			.getPO(getSuperVisor_Custom(), get_TrxName());	}

	/** Set SuperVisor_Custom.
		@param SuperVisor_Custom SuperVisor_Custom	  */
	public void setSuperVisor_Custom (int SuperVisor_Custom)
	{
		set_Value (COLUMNNAME_SuperVisor_Custom, Integer.valueOf(SuperVisor_Custom));
	}

	/** Get SuperVisor_Custom.
		@return SuperVisor_Custom	  */
	public int getSuperVisor_Custom () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_SuperVisor_Custom);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (org.adempiere.core.domains.models.I_AD_User)MTable.get(getCtx(), org.adempiere.core.domains.models.I_AD_User.Table_Name)
			.getPO(getSuperVisor_Shipment(), get_TrxName());	}

	/** Set SuperVisor_Shipment.
		@param SuperVisor_Shipment SuperVisor_Shipment	  */
	public void setSuperVisor_Shipment (int SuperVisor_Shipment)
	{
		set_Value (COLUMNNAME_SuperVisor_Shipment, Integer.valueOf(SuperVisor_Shipment));
	}

	/** Get SuperVisor_Shipment.
		@return SuperVisor_Shipment	  */
	public int getSuperVisor_Shipment () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_SuperVisor_Shipment);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Value_SAP.
		@param Value_SAP Value_SAP	  */
	public void setValue_SAP (String Value_SAP)
	{
		set_Value (COLUMNNAME_Value_SAP, Value_SAP);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Value_SAP);
	}
