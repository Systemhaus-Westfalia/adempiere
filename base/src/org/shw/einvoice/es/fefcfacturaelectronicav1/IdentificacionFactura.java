...
public class IdentificacionFactura implements Identificacion {

	static final int VERSION              = 1;
	static final String TIPO_DE_DOCUMENTO = "01";
	static final String TIPOMONEDA        = "USD";

	static final String VALIDATION_TIPOMODELO_FAILED_1         = "Documento: Factura, clase: Identificacion. Validacion falló: valor de 'tipoModelo' no debe ser diferente a 1";
	static final String VALIDATION_TIPOCONTINGENCIA_NOT_NULL   = "Documento: Factura, clase: Identificacion. Validacion falló: valor de 'tipoContingencia' debe ser ='null'";
	static final String VALIDATION_MOTIVOCONTINGENCIA_NOT_NULL = "Documento: Factura, clase: Identificacion. Validacion falló: valor de 'motivoContingencia' debe ser ='null'";
	static final String VALIDATION_TIPOMODELO_FAILED_2         = "Documento: Factura, clase: Identificacion. Validacion falló: valor de 'tipoModelo' no debe ser diferente a 2";
	static final String VALIDATION_TIPOCONTINGENCIA_IS_NULL    = "Documento: Factura, clase: Identificacion. Validacion falló: valor de 'tipoContingencia' no debe ser ='null'";
	static final String VALIDATION_MOTIVOCONTINGENCIA_IS_NULL  = "Documento: Factura, clase: Identificacion. Validacion falló: valor de 'motivoContingencia' no debe ser ='null'";
	...
	public void setFecAnula(String fecAnula) {
		throw new UnsupportedOperationException("In Document Factura calling the method Identificacion.setFecAnula() is not allowed");
	}
	...
	public void setHorAnula(String horAnula) {
		throw new UnsupportedOperationException("In Document Factura calling the method Identificacion.setHorAnula() is not allowed");
	}
	...
	public void setMotivoContigencia(String motivoContigencia) {
		throw new UnsupportedOperationException("In Document Factura calling the method Identificacion.setMotivoContigencia() is not allowed");
	}
	...
	public void setMotivoContingencia(String motivoContingencia) {
		throw new UnsupportedOperationException("In Document Factura calling the method Identificacion.setMotivoContingencia() is not allowed");
	}
